...
export const WORKSPACE_TOOL_DECLARATIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Clone a GitHub repository (public or private with authorized credentials) into the workspace 'repos/' directory.",
    parameters: {
      type: 'OBJECT',
      properties: {
        repoUrl: {
        ...
        branch: { type: 'STRING', description: 'Optional specific branch or tag to checkout' },
        depth: {
          type: 'INTEGER',
        ...
        folderName: {
          type: 'STRING',
          description:
            'Optional destination folder name under repos/ (defaults to repository name)',
        },
      },
      required: ['repoUrl'],
    },
  },
  {
    ...
    description:
      'List all imported/cloned GitHub repositories currently in the workspace repos directory, along with branch, commit, and file count information.',
